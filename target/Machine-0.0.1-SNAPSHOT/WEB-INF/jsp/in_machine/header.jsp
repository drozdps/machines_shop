...
<header>
	<div class="container no-padding">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
			<!-- ============================================================= LOGO ============================================================= -->
			<div class="logo">
				<a href="/machine"> <!--<img alt="vmc_and_hmc" src="resources/assets/images/vmc_and_hmc.svg" width="233" height="54"/>-->
					<img alt="vmc_and_hmc" src="resources/jpg/eftech.png" width="233"
					height="84" /> <!--<img alt="logo_vmccnc" src="resources/assets/images/logo_vmccnc.jpg" width="233" height="54"/>-->
		...
		<div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
			<div class="contact-row">
				<div class="phone inline">
					<i class="fa fa-phone"></i> <span class="le-color">+375 29 777-77-77</span>
				</div>
				<div class="contact inline">
					<!--<i class="fa fa-envelope"></i> contact@<span class="le-color">hmccnc.com</span>-->
					<i class="fa fa-envelope"></i> <span class="le-color">eftech@gmail.com</span>
				</div>
				<div class="contact inline">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
			<div class="top-cart-row-container">
				<div class="wishlist-compare-holder">
					<div class="wishlist ">
						<a href="wishlist.htm"><i class="fa fa-heart"></i> wishlist <span
							class="value">${wishlistCart.numberOfItems}</span> </a>
					</div>
					<div class="compare">
						<a href="compare.htm"><i class="fa fa-exchange"></i> compare <span
							class="value">${compareCart.numberOfItems}</span> </a>
					...
					<div class="basket">
						...
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							<div class="basket-item-count">
								<span class="count">${cart.numberOfItems}</span> <img
									src="resources/assets/images/icon-cart.png" alt="" />
							</div>
								...
								<div class="basket-item">
									<div class="row">
										<div class="col-xs-12 col-sm-6">
											...
											<a href="basket" class="le-button inverse">View cart</a>
										</div>
										<div class="col-xs-12 col-sm-6">
