	...
	<div class="wrapper">
		...
		<header>
			<div class="container no-padding">
				...
				<div
					class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
								...
								<div class="container-fluid">
									<div class="caption vertical-center text-left">
										...
										<div class="excerpt fadeInDown-2">
											on selected laptops<br> & desktop pcs or<br>
											smartphones
										</div>
										<div class="small fadeInDown-2">terms and conditions
											apply</div>
										<div class="button-holder fadeInDown-3">
											<a href="single-product.html" class="big le-button ">shop
												now</a>
										</div>
									</div>
									<!-- /.caption -->
			...
			<div class="container">
				<div class="col-xs-12 col-lg-6 no-margin banner">
					<a href="category-grid-2.html">
						...
						</div> <img class="banner-image" alt=""
						src="<c:url value="/resources/assets/images/blank.gif"/>"
						data-echo="<c:url value="/resources/assets/images/banners/banner-narrow-01.jpg"/>" />
					</a>
				</div>
				<div class="col-xs-12 col-lg-6 no-margin text-right banner">
					<a href="category-grid-2.html">
						...
						src="<c:url value="/resources/assets/images/blank.gif"/>"
						data-echo="<c:url value="/resources/assets/images/banners/banner-narrow-02.jpg"/>" />
					</a>
				</div>
			</div>
			<!-- /.container -->
			...
			<div class="container">
				<div class="tab-holder">
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="#new-arrivals" data-toggle="tab">new
								arrivals</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="featured">
								...
								<div
									...
									<div class="product-item">
										...
										<div class="body">
											...
											<div class="title">
												<a href="single-product.html">VAIO Fit Laptop - Windows
													8 SVF14322CXW</a>
											</div>
										...
										<div class="hover-area">
											<div class="add-cart-button">
												<a href="single-product.html" class="le-button">Добавить
													в корзину</a>
											</div>
							...
							<div class="loadmore-holder text-center">
								<a class="btn-loadmore" href="#"> <i class="fa fa-plus"></i>
									load more products
								</a>
							</div>
				...
				<div class="product-grid-holder medium">
							...
							<div
								...
								<div class="product-item">
									...
									<div class="body">
										<div class="label-discount clear"></div>
										<div class="title">
											<a href="single-product.html">beats studio headphones
												official one</a>
										</div>
							...
							<div
								...
								<div class="product-item">
									...
									<div class="body">
										<div class="label-discount clear"></div>
										<div class="title">
											<a href="single-product.html">playstasion 4 with four
												games and pad</a>
										</div>
										<div class="brand">acer</div>
									</div>
							...
							<div
								...
								<div class="product-item">
									...
									<div class="body">
										<div class="label-discount clear"></div>
										<div class="title">
											<a href="single-product.html">EOS rebel t5i DSLR Camera
												with 18-55mm IS STM lens</a>
										</div>
							...
							<div
								...
								<div class="product-item">
									...
									<div class="body">
										<div class="label-discount clear"></div>
										<div class="title">
											<a href="single-product.html">fitbit zip wireless
							...
							<div
								...
								<div class="product-item">
									...
									<div class="body">
										<div class="label-discount clear"></div>
										<div class="title">
											<a href="single-product.html">PowerShot elph 115 16MP
												digital camera</a>
										</div>
										<div class="brand">canon</div>
									</div>
					...
					<div class="col-xs-12 col-md-5 no-margin">
						<div
							...
							<div id="best-seller-single-product-slider"
								class="single-product-slider owl-carousel">
								<div class="single-product-gallery-item" id="slide1">
									<a data-rel="prettyphoto"
										href="images/products/product-gallery-01.jpg"> <img alt=""
							...
							<div class="body">
								<div class="label-discount clear"></div>
								<div class="title">
									<a href="single-product.html">CPU intel core i5-4670k
										3.4GHz BOX B82-12-122-41</a>
								</div>
								<div class="brand">sony</div>
							</div>
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-11.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-12.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-13.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-14.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-15.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
						...
						<div
							...
							<div class="product-item">
								...
								<div class="image">
									<img alt=""
										src="<c:url value = "/resources/assets/images/blank.gif"/>"
										data-echo="<c:url value="/resources/assets/images/products/product-16.jpg"/>" />
								</div>
								<div class="body">
									<div class="title">
				...
				<div class="carousel-holder">
					...
					<div class="title-nav">
						...
						<div class="nav-holder">
							<a href="#prev" data-target="#owl-brands"
								class="slider-prev btn-prev fa fa-angle-left"></a> <a
								href="#next" data-target="#owl-brands"
								class="slider-next btn-next fa fa-angle-right"></a>
						</div>
					</div>
					<!-- /.title-nav -->
					...
					<div id="owl-brands" class="owl-carousel brands-carousel">
						...
						<div class="carousel-item">
							<a href="#"> <img alt=""
								src="<c:url value="/resources/assets/images/brands/brand-01.jpg"/>" />
							</a>
						</div>
						<!-- /.carousel-item -->
						...
						<div class="carousel-item">
							<a href="#"> <img alt=""
								src="<c:url value="/resources/assets/images/brands/brand-02.jpg"/>" />
							</a>
						</div>
						<!-- /.carousel-item -->
						...
						<div class="carousel-item">
							<a href="#"> <img alt=""
								src="<c:url value="/resources/assets/images/brands/brand-03.jpg"/>" />
							</a>
						</div>
						<!-- /.carousel-item -->
						...
						<div class="carousel-item">
							<a href="#"> <img alt=""
								src="<c:url value="/resources/assets/images/brands/brand-04.jpg"/>" />
							</a>
						</div>
						<!-- /.carousel-item -->
