...
<header>
	<div class="container no-padding">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
			<!-- ============================================================= LOGO ============================================================= -->
			<div class="logo">
				<a href="index.htm"> <!--<img alt="vmc_and_hmc" src="resources/assets/images/vmc_and_hmc.svg" width="233" height="54"/>-->
					<img alt="vmc_and_hmc" src="resources/jpg/admin.jpg" width="233"
					height="220" /> <!--<img alt="logo_vmccnc" src="resources/assets/images/logo_vmccnc.jpg" width="233" height="54"/>-->
		...
		function formSubmit() {
			document.getElementById("logoutForm").submit();
					...
					<form method="POST"
						action="uploadFile.htm?${_csrf.parameterName}=${_csrf.token}"
						enctype="multipart/form-data">
						Import machine form XLS: <input type="file" name="file" /><input
